...
function [CPs] = multiGaussSegmentation(X)
close all;
% clearvars;
% clc

addpath(genpath('C:\Users\parnaa01\Box Sync\code\Matlab\automatic segmentation\changepoint-detection-master'))
%% Import data
...
%% my data
% % t = readtable('mod_feeding 1.csv'); % this leads to excellant results
...
%% comparing with the timestamps in the labeled data
% [CPs timeStamps]

% lengthAutoSeg = N_CPs
% lengthManualSeg = length(timeStamps)
